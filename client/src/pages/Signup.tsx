...
export default function Signup() {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({ title: "Account created!", description: "Welcome to Srikanakadurganursery!" });
      setLocation("/");
    } catch (err: any) {
      ...
      <div className="flex items-center justify-center py-16 px-4">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h1 className="font-heading text-3xl font-bold text-[#1A1A1A] tracking-wide uppercase" data-testid="text-signup-title">
              Create Account
            </h1>
          ...
          <div className="bg-white rounded-sm p-8 shadow-sm">
            ...
            <p className="text-center text-sm text-[#4A4A4A] mt-6">
              ...
              <Link href="/login">
                <span className="text-[#2F4836] font-semibold hover:underline cursor-pointer" data-testid="link-login">
                  Sign In
                </span>
              </Link>
            </p>
